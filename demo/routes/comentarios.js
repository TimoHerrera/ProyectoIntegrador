...
router.get('/prodDetail',comentarioController.findAll);//cambiar prefijo NO HAY UNA VISTA DEDICADA A TODOS LOS COMMENTS! puede ser que no necesite ese entonces
