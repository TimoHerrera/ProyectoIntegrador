...
insert into usuarios (id_usuario,email,pssword,fotoPerfil,fecha,dni,createdAt,updatedAt) values (default,'micaela_zazzuolo@hotmail.com','mZazzu345','../imagenes/paula.jpeg', '2023-04-06','19356789', default, default);

-- insertar 10 posteos
insert into productos (id_producto,nombreProducto,descripcionProducto,id_usuario,createdAt,updatedAt) values (default,'Conjunto 3 Tiras Aeroready Essentials Corte Clásico','Sin importar cómo lo usés, la tecnología AEROREADY se encarga de mantener tu cuerpo seco y cómodo de la mañana a la noche',default,default,default);
insert into productos (id_producto,nombreProducto,descripcionProducto,id_usuario,createdAt,updatedAt) values (default,'Remera De Entrenamiento Train Essentials','La tecnología AEROREADY se encarga del sudor para que sientas comodidad en todo momento. Su diseño te ofrece una total libertad de movimiento, así que animate y levantá esas pesas',default,default,default);
insert into productos (id_producto,nombreProducto,descripcionProducto,id_usuario,createdAt,updatedAt) values (default,'Remera Run It','El tejido ligero y transpirable te brinda soporte desde el primer al último paso y la tecnología AEROREADY absorbe el sudor para mantener tu piel fresca y seca en todo momento',default,default,default);
insert into productos (id_producto,nombreProducto,descripcionProducto,id_usuario,createdAt,updatedAt) values (default,'Buzo Con Capucha Essentials Logo Lineal Felpa','Este buzo con capucha adidas recompensa tu esfuerzo y el dolor muscular para que puedas rendir al máximo. Porque este buzo hace más fácil tu vida, y eso es lo que te merecés.',default,default,default);
insert into productos (id_producto,nombreProducto,descripcionProducto,id_usuario,createdAt,updatedAt) values (default,'Gorra Béisbol 3 Tiras Sarga (unisex)','Esta nueva versión del look clásico ofrece un tacto suave y un diseño con protección UV. Luce un logo adidas Badge of Sport que le da un nuevo giro a tu orgullo por las 3 Tiras',default,default,default);
insert into productos (id_producto,nombreProducto,descripcionProducto,id_usuario,createdAt,updatedAt) values (default,'Remera Essentials Mezcla','Esta remera adidas es más que capaz de brindarte comodidad de la mañana a la noche. Está hecha de un tejido de una mezcla de poliéster y algodón suave y texturizado, pero a la vez muy fresco',default,default,default);
insert into productos (id_producto,nombreProducto,descripcionProducto,id_usuario,createdAt,updatedAt) values (default,'Calzas Farm Rio Feel Brilliant Aeroready Pretina Alta','En el gimnasio, en la ciudad o en la carretera, movete siempre con estilo. Estas calzas adidas son el resultado de una colaboración con FARM Rio. Lucen llamativos estampados en la pierna y en la cintura de pretina alta',default,default,default);
insert into productos (id_producto,nombreProducto,descripcionProducto,id_usuario,createdAt,updatedAt) values (default,'Shorts Essentials Chelsea 3 Tiras Aeroready','Diseñados para los días ajetreados, estos shorts adidas incorporan un calzoncillo interior de malla transpirable que ofrece mayor cobertura y comodidad en todo momento. El tejido AEROREADY con tecnología de absorción se encarga de mantener tu piel seca mientras te ejercitás',default,default,default);
